...
def generate_launch_description():
    ...
    launch_file_dir = PathJoinSubstitution([FindPackageShare('happy_gazebo'), 'launch'])

    # setup classic gazebo
    classic_gazebo_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            PathJoinSubstitution([launch_file_dir, 'classic_gazebo.launch.py'])
        ),
        launch_arguments={
    ...
    ignition_gazebo_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            PathJoinSubstitution([launch_file_dir, 'ignition_gazebo.launch.py'])
        ),
        launch_arguments={
            'gui': gui,
            'world_fname': world_fname
